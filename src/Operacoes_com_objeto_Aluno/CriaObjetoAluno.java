...
public class CriaObjetoAluno extends Aluno {
	...
	public void aprovadoReprovado(List aluno, double media, List nota, boolean status) {
		...
		JOptionPane.showMessageDialog(null, (status ? StatusAluno.APROVADO : StatusAluno.REPROVADO));
	...
	public static boolean validaAcesso() {

		String loginAcesso = JOptionPane.showInputDialog("Digite seu login");
		String senhaAcesso = JOptionPane.showInputDialog("Digite sua senha");
		String senha = "123456";
		String login = "Bruno";
		if (login.equalsIgnoreCase(loginAcesso) && senha.equalsIgnoreCase(senhaAcesso)) {
			return true;
		} else {
			return false;
		}
